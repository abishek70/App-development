...
import Privacy from '../css/Privacy.css'
  ...
  return (
    ...
    <div className="privacy">
      ...
      <p className='styletext'>
        This Privacy Policy governs the manner in which Airtel Recharge collects, uses, maintains, and discloses
        information collected from users (each, a "User") of the Airtel Recharge website.
...
<br></br>
Airtel and its group companies may collect, store, process and transfer your Personal Information well in accordance with the applicable laws and regulations for a variety of regulatory and business purposes. 
<br></br>
<br></br>
...
For any responsible disclosure of a security vulnerability in our website, mobile application or our services, please send an email to securitybugs@airtel.com.
<br></br>
<br></br>
...
We reserves the right to modify this Privacy Notice. We will post any changes do our Privacy Notice on this page. Please check the “Last Updated” legend at the top of this page to see when this Privacy Notice was last revised. We encourage you to check frequently to see the current Privacy Notice to be informed of how Airtel is committed to protecting your information and providing you with improved conten
      </p>
